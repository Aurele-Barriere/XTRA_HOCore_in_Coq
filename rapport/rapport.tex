...
\maketitle
\begin{abstract}
  Ce document résume l'article \cite{hocoreincoq}. Il traite de la formalisation en Coq (l'assistant de preuve) du calcul de processus HOCore. On y présente le calcul et des propriétés, puis on s'intéresse aux enjeux de la formalisation et de la réalisation de preuves en Coq. 
  \begin{description}
