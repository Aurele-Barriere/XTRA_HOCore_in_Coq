...
Il existe un moyen de se débarrasser des noms de varParmi les variables, il faut distinguer celles qui sont dites \textit{libres} et celles dites \textit{liées}.
...
%plus d'explications nécessaires... faut que je comprenne bien d'abord
